...
(
    ...
    localparam PAD7 = log2ceil(64'h11074 - 64'h11070); 
    localparam PAD8 = log2ceil(64'h11078 - 64'h11074); 
    // -------------------------------------------------------
    ...
    // ( 0x11068 .. 0x11070 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 17'h11068  && read_transaction  ) begin
            src_channel = 9'b000010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 7;
    end

    // ( 0x11070 .. 0x11074 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 17'h11070  && write_transaction  ) begin
            src_channel = 9'b010000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 4;
    end

    // ( 0x11074 .. 0x11078 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 17'h11074  && read_transaction  ) begin
