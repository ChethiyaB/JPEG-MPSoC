...
(
    ...
    localparam PAD9 = log2ceil(64'h410b4 - 64'h410b0); 
    localparam PAD10 = log2ceil(64'h410b8 - 64'h410b4); 
    localparam PAD11 = log2ceil(64'h410bc - 64'h410b8); 
    localparam PAD12 = log2ceil(64'h410c0 - 64'h410bc); 
    // -------------------------------------------------------
    ...
    // ( 0x410a8 .. 0x410b0 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 19'h410a8  && read_transaction  ) begin
            src_channel = 13'b0000000000100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 11;
    end

    // ( 0x410b0 .. 0x410b4 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 19'h410b0  && write_transaction  ) begin
            src_channel = 13'b0100000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 6;
    end

    // ( 0x410b4 .. 0x410b8 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 19'h410b4  && write_transaction  ) begin
            src_channel = 13'b0001000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 4;
    end

    // ( 0x410b8 .. 0x410bc )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 19'h410b8  && write_transaction  ) begin
            src_channel = 13'b0000010000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 8;
    end

    // ( 0x410bc .. 0x410c0 )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 19'h410bc  && write_transaction  ) begin
